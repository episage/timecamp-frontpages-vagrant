...
PHP
		echo "Installing timecamp-frontpages..."
		wp core install --url=local.wordpress.dev --quiet --title="Local timecamp-frontpages Dev" --admin_name=admin --admin_email="admin@local.dev" --admin_password="password"
	else
		echo "Updating timecamp-frontpages..."
		cd /srv/www/timecamp-frontpages
		git pull
	fi
